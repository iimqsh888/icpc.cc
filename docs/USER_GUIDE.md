...
Complete guide for using the Common Prosperity Coin ecosystem.
...
2. **BNB for Gas**
   - Keep ~0.01 BNB for transactions
   - Available on Binance, exchanges
...
### Method 1: Airdrop (Free!)

**Requirements:**
- BABT NFT (Binance Account Bound Token)
...
### Method 2: NFT Presale

**Purchase NFTs and earn CPC rewards**

**Steps:**
1. Visit DApp
2. Go to NFT Sale section
3. Choose amount (1, 10, 100, or 1000 BNB)
4. Click purchase button
5. Confirm transaction
6. Receive NFT + CPC rewards

### Method 3: OTC Trading

**Buy from other users**

**Steps:**
1. Visit OTC platform
2. Browse sell orders
3. Click "Fill Order"
4. Confirm transaction
5. Receive CPC tokens

## ⛏️ Mining (Staking)

### Activate Mining

**One-time activation fee: 2 USDT**

**Steps:**
1. Visit DApp
2. Go to Mining section
3. Click "Activate Staking"
4. Approve USDT
5. Confirm transaction
...
4. Receive CPC + NFT rewards

## 💱 OTC Trading

### Create Buy Order

**Buy CPC from sellers**
...
3. Select "Buy"
4. Enter:
   - Token amount (must be whole numbers)
   - Price per token (in BNB)
5. Pay: Total BNB + 0.001 BNB fee
6. Confirm transaction
7. Wait for sellers to fill
...
4. Enter:
   - Token amount (must be whole numbers)
   - Price per token (in BNB)
5. Approve CPC tokens
6. Pay 0.001 BNB creation fee
7. Confirm transaction
8. Wait for buyers to fill

### Fill Orders

**Complete existing orders**

**For Buy Orders (you sell CPC):**
1. Browse buy orders
2. Click "Fill"
3. Approve CPC tokens
4. Confirm transaction
5. Receive BNB (minus 0.2% fee)

**For Sell Orders (you buy CPC):**
...
|--------|-----|-------------|
| Create Order | 0.001 BNB | Voting Contract |
| Fill Order | 0.2% of trade | Voting Contract |

### Mining

| Action | Fee |
|--------|-----|
| Activation | 2 USDT (one-time) |
| Staking | Free |
| Claiming | Free (gas only) |

### Voting

| Action | Fee |
|--------|-----|
| Become Candidate | 1 CPC stake (returned) |
...
1. Verify BABT NFT ownership
2. Check if already claimed
3. Ensure on BSC Mainnet
...
3. Verify order is active
4. Check order details
5. Ensure sufficient BNB
...
4. **Community**: Join Telegram/Discord
5. **BSCScan**: Verify transactions
...
3. Participate every round
4. Withdraw stakes promptly
...
3. Claim regularly
4. Reinvest profits
5. Diversify strategy

## 📈 Maximizing Returns

### Strategy 1: Active Trading

1. Monitor OTC prices
2. Create competitive orders
